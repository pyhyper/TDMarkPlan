...
<div class="ereader-container">
    ...
    <header class="ereader-header">
        ...
        <div class="dynamic-link-badge" id="dynamic-link-pill">
            ...
            <span id="dynamic-link-slug"><?php echo $requestedPlan ? '/' . htmlspecialchars($requestedPlan) : 'Đang tạo link…'; ?></span>
    ...
    <main class="ereader-body">
        ...
        <section class="view-panel" id="view-wizard">
            ...
            <div id="wiz-paste-result-card" class="import-card" style="display:none;">
                <h3 style="font-size:1.15rem; font-weight:700; color:var(--ink-primary); margin-bottom:0.5rem;" data-i18n="wizard.step4_heading">
                     Bước 2: Dán Kết Quả Markdown Từ AI & Bắt Đầu Học
                </h3>
                <p style="font-size:0.85rem; color:var(--ink-secondary); line-height:1.45; margin-bottom:0.75rem;" data-i18n="wizard.step4_desc">
                    Sau khi ChatGPT hoặc Gemini trả lời, bạn bấm nút copy code block Markdown và dán vào đây:
                </p>
                <textarea class="textarea-md" id="wiz-paste-markdown" placeholder="Dán nội dung PLAN.md do ChatGPT hoặc Gemini tạo ra vào đây..." data-i18n-placeholder="wizard.paste_placeholder"></textarea>
                <div id="wiz-import-preview-box" style="display:none; padding:1rem; border-radius:6px; margin-bottom:1rem;"></div>
                <button class="btn-primary" data-i18n="wizard.btn_import_start" onclick="App.importFromWizard()">
...
<h2>Nhật ký thu chi</h2>
        ...
        <section class="view-panel" id="view-import">
            <div class="chapter-header">
                <div class="chapter-sub" data-i18n="import.sub_heading">Công Cụ Nhập Kế Hoạch</div>
                <h1 class="chapter-title" data-i18n="import.heading">Nhập PLAN.md</h1>
            </div>
            ...
            <div class="import-card">
                ...
                <div class="dropzone" id="dropzone">
                    ...
                    <div style="font-weight:600; margin-bottom:0.25rem;" data-i18n="import.drop_title">Kéo & thả file PLAN.md vào đây</div>
                    <div style="font-size:0.85rem; color:var(--ink-muted);" data-i18n="import.drop_sub">hoặc bấm để chọn file từ máy tính của bạn</div>
                    <input type="file" id="plan-file-input" accept=".md,.markdown,.txt" style="display:none;">
                </div>

                <!-- Or Paste Markdown -->
                <label style="display:block; font-family:var(--font-sans); font-size:0.875rem; font-weight:600; margin-bottom:0.5rem;" data-i18n="import.paste_label">
                    Hoặc dán nội dung Markdown trực tiếp:
                </label>
                <textarea class="textarea-md" id="import-markdown" placeholder="Dán nội dung PLAN.md do ChatGPT hoặc Gemini tạo vào đây..." data-i18n-placeholder="import.paste_placeholder"></textarea>
                ...
                <div style="margin-bottom: 1.25rem; background:var(--bg-page); padding:0.85rem 1rem; border:1px solid var(--border-color); border-radius:6px;">
                    <label style="display:block; font-family:var(--font-sans); font-size:0.85rem; font-weight:600; margin-bottom:0.35rem;" data-i18n="import.pin_label">
                         Bảo vệ link bằng mã PIN / Mật khẩu (Tùy chọn):
                    </label>
                    <input type="password" id="import-password" placeholder="Ví dụ: 1234 (để trống nếu muốn link mở tự do)" data-i18n-placeholder="import.pin_placeholder" style="width:100%; padding:0.5rem 0.75rem; border:1px solid var(--border-color); border-radius:5px; background:var(--bg-card); color:var(--ink-primary); font-family:var(--font-mono); font-size:0.85rem;">
                    <div style="font-size:0.75rem; color:var(--ink-muted); margin-top:0.25rem;" data-i18n="import.pin_help">
                        Nếu đặt PIN, người xem link cần nhập mã này để xem hoặc hoàn thành nhiệm vụ.
                    </div>
                </div>

                <div class="import-actions">
                    <div class="sample-buttons">
                        <span data-i18n="import.sample_label">Nạp mẫu nhanh:</span>
                        <button class="btn-sample" onclick="App.loadExamplePlan('ielts-6.5')" data-i18n="import.sample_ielts">IELTS 6.5 (12 Tuần)</button>
                        <button class="btn-sample" onclick="App.loadExamplePlan('coding-roadmap')" data-i18n="import.sample_coding">Lập Trình Full-Stack</button>
                        <button class="btn-sample" onclick="App.loadExamplePlan('fitness-5k')" data-i18n="import.sample_fitness">Tập Chạy 5K</button>
                    </div>
                    <button class="btn-primary" data-i18n="import.btn_import" onclick="App.savePlanMarkdown(document.getElementById('import-markdown').value, null, document.getElementById('import-password').value)">
                        Nhập Kế Hoạch & Bắt Đầu Học Ngay →
                    </button>
                </div>
            </div>
